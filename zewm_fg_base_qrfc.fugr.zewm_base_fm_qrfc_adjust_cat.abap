*----------------------------------------------------------------------*
* Title  FM ZEWM_BASE_FM_QRFC_CREA_OD_SO
...
*----------------------------------------------------------------------*
* Program description:
* Adjusments Suplus CAT - Posting  OF -> 1F
*----------------------------------------------------------------------*
FUNCTION zewm_base_fm_qrfc_adjust_cat.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*    gc_stock_cat_4q TYPE /lime/stock_category  VALUE '4Q'.
...
*    ls_cat_r-low    = gc_stock_cat_4q.
    ls_cat_r-low    = ls_ordim_c-cat.
...
*    ls_item-source_s-cat           = gc_stock_cat_4q.
    ls_item-source_s-cat           = ls_ordim_c-cat.
